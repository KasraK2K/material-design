...
@section('pagetitle')
    ...
    <seaction id="portfolio-header">
        <div class="small-12 medium-12 large-12 columns page-title text-center caption">
            <h2 class="text-3d">ارسال شکایت برای مدیریت</h2>
        </div>
    </seaction>
@endsection
    ...
    <section id="complaint">
        <div class="row">
            <div class="small-12 medium-6 medium-offset-1 large-6 large-offset-1 columns">
                <blockquote>
                    <h5 class="dark-stork-shadow">فرم ارسال شکایت</h5>
                </blockquote>
                <form action="" id="complaint-form" data-abide>
                    <!--name-->
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="small-4 medium-3 large-3 columns">
                            <label class="inline" for="subject">موضوع شکایت</label>
                        </div>
                        <div class="small-8 medium-9 large-9 columns">
                            <input required type="text" class="text-right" id="subject" placeholder="موضوع پیام شما ...">
                            <small class="error text-right">لطفا موضوع شکایت خود را وارد نمایید.</small>
                        </div>
                    </div>
                    <!--Relevant section-->
                    <div class="row">
                        <div class="small-4 medium-3 large-3 columns">
                            <label class="inline">بخش مربوطه</label>
                        </div>
                        <div class="small-8 medium-9 large-9 columns">
                            <select>
                                <option value="مالی">مالی</option>
                                <option value="طراحی سایت">طراحی سایت</option>
                                <option value="بهینه سازی سایت">بهینه سازی سایت</option>
                                <option value="تبلیغات در گوگل">تبلیغات در گوگل</option>
                                <option value="تبلیغات در اینستاگرام">تبلیغات در اینستاگرام</option>
                                <option value="اپلیکیشن اندروید">اپلیکیشن اندروید</option>
                    ...
                    <div class="row">
                        ...
                        <div class="small-8 medium-9 large-9 columns">
                            <textarea required name="message" id="message" cols="30" rows="5" class="text-right" placeholder="متن پیام شما ..."></textarea>
                            <small class="error text-right">
